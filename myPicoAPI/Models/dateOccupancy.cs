namespace myPicoAPI.Models {
  public class dateOccupancy {
    ...
    public int day_32 { get; set; }
    public int day_33 { get; set; }
    public int day_34 { get; set; }
    public int day_35 { get; set; }
     public int day_36 { get; set; }
     public int day_37 { get; set; }
     public int day_38 { get; set; }
     public int day_39{ get; set; }
     public int day_40 { get; set; }
     public int day_41{ get; set; }
     public int day_42 { get; set; }
  }
}